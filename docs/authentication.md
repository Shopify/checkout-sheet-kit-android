...
Configure access to the API via the headless sales channel...
Why the headless sales channel?

Once configured, expose the relevant values to your application:
```kotlin
SHOP_ID="<your-shop-id>"
CUSTOMER_ACCOUNTS_CLIENT_ID="<your-client-id>"
CUSTOMER_ACCOUNTS_REDIRECT_URI="shop.<shop-id>.app://callback" // Optional, will use default if not specified
```
...
var components = URLComponents(string: "https://shopify.com/authentication/${BuildConfig.shopId}/oauth/authorize")
